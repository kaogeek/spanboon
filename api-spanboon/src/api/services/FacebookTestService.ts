...
@Service()
export class FacebookTestService {
    ...
    public createFB(): Facebook {
        ...
        options.appId = facebook_setup.FACEBOOK_TEST_APP_ID;
        options.version = facebook_setup.FACEBOOK_VERSION;
        options.appSecret = facebook_setup.FACEBOOK_TEST_APP_SECRET;
    ...
    public getAppAccessToken(): Promise<any> {
        return new Promise((resolve, reject) => {
            FB.api('oauth/access_token', {
                client_id: facebook_setup.FACEBOOK_TEST_APP_ID,
                client_secret: facebook_setup.FACEBOOK_TEST_APP_SECRET,
