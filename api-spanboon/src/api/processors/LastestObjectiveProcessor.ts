            ...
            try {
                ...
                for (const row of searchResult) {
                    ...
                    if (hashtag) {
                        ...
                        const matchStmtPost = lastestFilter.whereConditions;
                        ...
                        searchResultPost = await this.postsService.aggregate(postStmt);
                        contentModel.post = searchResultPost;
                    }
                    result.contents.push(contentModel);
                }
