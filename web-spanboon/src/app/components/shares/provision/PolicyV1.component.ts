...
const PAGE_NAME: string = 'privacy-policy-v1';

@Component({
    selector: 'privacy-policy-v1',
    templateUrl: './PolicyV1.component.html',
})

export class PolicyV1 extends AbstractPage implements OnInit {
