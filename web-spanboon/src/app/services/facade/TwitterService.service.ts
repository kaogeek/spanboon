...
export class TwitterService extends AbstractFacade {
    ...
    */
    ...
    //     const urlCallback = '?oauth_callback=' + encodeURIComponent(environment.webBaseURL + callback);
    //     const url: string = environment.spanboonProxy + 'https://api.twitter.com/oauth/request_token' + urlCallback;
    ...
    //         oauth_callback: environment.webBaseURL + callback, // this call back must in developer callback list in twitter dev page.
    //         oauth_version: '1.0'
    //     };
    ...
    public getAcessToKen(accessTokenLink: string, httpOptions) {
        return new Promise((resolve, reject) => {
            console.log('accessTokenLink url ',accessTokenLink)
