...
export class VoteEventFacade extends AbstractFacade {
  ...
  public showHide(id: any, body: any): Promise<VoteEvent[]> {
    return new Promise((resolve, reject) => {
      let url: string = this.baseURL + '/admin/voted/hide/' + id;
      let options = this.getDefaultOptions();
      this.http.post(url, body, options).toPromise().then((response: any) => {
        resolve(response.data);
      }).catch((error: any) => {
  ...
  public sendNoti(data: any): Promise<VoteEvent[]> {
    return new Promise((resolve, reject) => {
      // let url: string = this.baseURL + '/admin/line/test/vote/';
      let url: string = this.baseURL + '/admin/line/vote/';
      let body = data;
      let options = this.getDefaultOptions();
      this.http.post(url, body, options).toPromise().then((response: any) => {
        resolve(response.data);
