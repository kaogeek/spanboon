...
@Injectable()
export class PointCategoryFacade extends AbstractFacade {
  ...
  public search(): Promise<[]> {
    return new Promise((resolve, reject) => {
      let url: string = this.baseURL + '/admin/point/category/search';
      let body = {}
  ...
  public create(data: any): Promise<[]> {
    return new Promise((resolve, reject) => {
      let url: string = this.baseURL + '/admin/point/category';
      let body = data;
      let options = this.getDefaultOptions();
      this.http.post(url, body, options).toPromise().then((response: any) => {
        resolve(response.data);
  ...
  public update(data: any, id: string): Promise<[]> {
    return new Promise((resolve, reject) => {
      let url: string = this.baseURL + '/admin/point/category/' + id;
      let body = data;
      let options = this.getDefaultOptions();
